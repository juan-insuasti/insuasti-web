  ...
  return (
    <SectionFullPage className="relative">
      <div className="absolute inset-0 -z-10 inline-flex h-full w-full animate-pulse items-center justify-center overflow-hidden blur-3xl filter duration-3000">
        <div className="absolute ml-[-3em] aspect-square h-full animate-spin rounded-full bg-gradient-to-tr from-primary to-background opacity-20 blur-xl duration-3000 dark:to-secondary dark:opacity-35" />
        <div className="absolute aspect-square h-full animate-spin rounded-full bg-gradient-to-bl from-background to-primary opacity-20 blur-3xl duration-3000 dark:from-secondary dark:opacity-35" />
      </div>
